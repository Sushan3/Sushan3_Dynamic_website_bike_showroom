        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding:40px 50px;">
                    <form role="form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="dateofbirth" name="dateofbirth" placeholder="Enter dateofbirth" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" id="usrname" name="gender" value="male" required 		checked="">male
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="Cancel" ><span class="glyphicon glyphicon-remove"></span> Cancel</button>
        ...
        <div id="login-overlay" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 align="center" class="modal-title" id="myModalLabel">Login to KTM Duke Showroom</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            ...
                            <ul class="list-unstyled" style="line-height: 2">
                                <li><span class="fa fa-check text-success"></span> Instant Receive Notification</li>
                            ...
                            <button type="button" class="btn btn-info btn-block" id="signupbtn">Yes please, register now!</button>
